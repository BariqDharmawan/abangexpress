    ...
    {{-- @isset($contact) --}}
        <x-admin.modal id="update-contact" heading="Change contact">
            ...
            action="{{ route('admin.our-contact.update') }}" data-modal-id="update-contact">
                ...
                value="{{ $contact->address ?? null }}" name="address" required />

                <x-admin.input label="Link google maps" type="url"
                value="{{ $contact->link_address  ?? null }}" name="link_address"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        id="our-telephone" value="{{ old('telephone') ?? $contact->telephone  ?? null }}"
                        pattern="^(?!62)(?!0)\w+$"
